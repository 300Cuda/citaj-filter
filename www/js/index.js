...
var app = {
    ...
    receivedEvent: function(id) {
		...
		ref.addEventListener("loadstop", function() {
		  ...
		  ref.executeScript({
			code: "var button = document.createElement('Button'); button.innerHTML = 'Share'; button.style = 'top:0;right:0;position:fixed;'; document.body.appendChild(button); button.setAttribute('onclick','otherShare();');"
		  });
